...
<!-- 
here get the data from about table and fill hidden input with id and textarea with text field 
,i dont want the page to refresh hint using (ajax)
for the textarea display hit use jquery show and hide function and .html() and search for .text() functions 
and slideup() , and slideDown() and $.each
-->
<?php
...
<form action="edit-text.php" method="post"> 
  ...
  <textarea name="about_us" rows="5" cols="40" ><?php echo $row['text']; ?></textarea>
  <br><br>
